...
[No!] An installer log file is created during the install. 
[Yes!] An installer log file is created during the installation.
 
 
[No!] Click Finish to exit the uninstall.
[Yes!] Click Finish to exit the uninstallation.              
 
 
[No!] After the import, you must set certificates for the HTTPS and HTTPSCA transports.
[Yes!] After importing the files, you must set certificates for the HTTPS and HTTPSCA transports.
...
No!    You will have to manually register a bwagent in the agent network for it to communicate with the server.
Yes!   You have to manually register a bwagent in the agent network for it to communicate with the server.
 
 
No!    In this case, the following message will be displayed:
Yes!  In this case, the following message is displayed:
 
 
No!    After you created an adapter application, you have to generate the application archive.
...
Yes!  The engine always executes a job in one engine thread; however, it is not guaranteed that the same engine thread will be used for the entirety of the job.
...
Yes!  You can add a model to the project that you created in the previous step.
...
No! After you provide the login credentials, click Login. The Welcome window appears.
 
Yes! After you provide the login credentials, click Login. The Welcome window opens.
 
 
No! The message appears when you make a mistake.
 
Yes! The message is displayed when you make a mistake.
 
 
Note: Use of passive voice is acceptable because "displays" is a transitive verb that must have an object. So, it is preferable to write "is displayed." 
 
For example: 
 
No! The message displays.
 
Yes! The message is displayed.
